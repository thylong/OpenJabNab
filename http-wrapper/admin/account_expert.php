...
<tr>
  <td><?php echo $mac ?></td>
  <td>
    <a class="btn btn-small" href="bunny_expert.php?mac=<?php echo $mac ?>"><?php echo __tr('Expert') ?></a>&nbsp;
    <a class="btn btn-small" href="/bunny/index.php?b=<?php echo $mac ?>"><?php echo __tr('View') ?></a>
    <a class="btn btn-small btn-danger" href="?accid=<?php echo $account['id']; ?>&rm_b=<?php echo $mac; ?>"><?php echo __tr('Remove'); ?></a>
  </td>
</tr>
<?php endforeach; ?>u
<?php else: ?>
...
<tr>
  <td><?php echo $mac ?></td>
  <td>
    <a class="btn btn-small" href="ztamp_expert.php?mac=<?php echo $mac ?>"><?php echo __tr('Expert') ?></a>&nbsp;
    <a class="btn btn-small" href="/account/ztamp.php?z=<?php echo $mac ?>"><?php echo __tr('View') ?></a>
    <a class="btn btn-small btn-danger" href="?accid=<?php echo $account['id']; ?>&rm_z=<?php echo $mac; ?>"><?php echo __tr('Remove'); ?></a>
</td>
</tr>
<?php endforeach; ?>
<?php else: ?>
<tr><td colspan="2"><?php echo __tr('No ztamp in this account') ?></td></tr>
<?php endif; ?>
  </table>
