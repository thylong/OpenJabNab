	      	...
	      	<div class="span6">
					<div class="widget">
						...
						<div class="widget-header">
							...
							<h3><?php echo __tr('Connected bunnies') ?></h3>
						</div>
...
*/ ?>
	      	...
	      	<div class="span6">
					...
					<div class="widget">
						...
						<div class="widget-header">
							<i class="icon-bar-chart"></i>
							<h3><?php echo __tr('Breathing colors of bunnies') ?></h3>
						</div>
...
<?php /*<div class="widget">
						...
						<div class="widget-content">
							<div id="apiday-chart" class="chart-holder"></div>
		...
		<div class="span12"> */ ?>
					<div class="widget">
						...
						<div class="widget-header">
							<i class="icon-bar-chart"></i>
							<h3><?php echo __tr('Maximum number of bunnies') ?></h3>
						</div>
