...
?>
		...
		<ul class="nav nav-tabs">
		  <li<?php echo $_SESSION['subtab'] == 'fairytales_preset' ? ' class="active"' : '' ?>><a href="#preset" data-toggle="tab"><?php echo __tr('Presets') ?></a></li>
		  <li<?php echo $_SESSION['subtab'] == 'fairytales_schedule' ? ' class="active"' : '' ?>><a href="#schedule" data-toggle="tab"><?php echo __tr('Schedules') ?></a></li>
		  <li<?php echo $_SESSION['subtab'] == 'fairytales_rfid' ? ' class="active"' : '' ?>><a href="#rfid" data-toggle="tab"><?php echo __tr('RFID') ?></a></li>
		</ul>
		<br />
...
<table class="table table-bordered table-striped span11">
	<tr>
		<th colspan="4"><?php echo __tr('Fairy tales list') ?></th>
	</tr>
	<tr>
...
<?php if(!preg_match('/^OJN_/', $key)): ?>
			<a class="btn btn-danger" href="bunny_plugin.php?p=fairytales&rp=<?php echo urlencode($key) ?>"><?php echo __tr("Remove") ?></a>
<?php endif; ?>
			<a class="btn btn-success" href="bunny_plugin.php?p=fairytales&play=<?php echo urlencode($key) ?>"><?php echo __tr("Play") ?></a>
		</td>
		<td class="span2"><?php if($default != preg_replace('/OJN_/', '', $key)) { ?><a class="btn btn-primary" href="bunny_plugin.php?p=fairytales&d=<?php echo urlencode($key) ?>"><?php echo __tr("Set as default") ?></a><?php } else { ?><?php echo __tr("Default fairy tale") ?><?php } ?></td>
	</tr>
<?php } ?>
</table>
<?php
...
?>
	<tr<?php echo $i++ % 2 ? " class='l2'" : "" ?>>
		...
		<td width="15%"><a href="bunny_plugin.php?p=fairytales&rwd=<?php echo $day ?>&rw=<?php echo $time ?>" class="btn btn-danger"><?php echo __tr('Remove') ?></a></td>
	</tr>
<?php  } ?>
</table>
<?php } ?>
...
<tr>
	...
	<td><a href="bunny_plugin.php?p=fairytales&rtag=<?php echo $k ?>" class="btn btn-danger btn-small"><i class="icon-trash icon-large"></i> <?php echo __tr('Remove') ?></a></td>
</tr>
<?php endforeach; ?>
