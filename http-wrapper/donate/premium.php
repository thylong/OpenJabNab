    ...
    <div class="span12">
        <div class="widget widget">
            <div class="widget-header">
                <i class="icon-list-alt"></i><h3><?php echo __tr("What about the premium status ?") ?></h3>
            </div>
...
<?php if(isset($_SESSION['login'])): ?>
    <div class="span5">
        ...
        <div class="widget widget">
            <div class="widget-header">
                <i class="icon-list-alt"></i><h3><?php echo __tr("Premium registration") ?></h3>
            </div>
            <div class="widget-content">
<?php
$link = mysqli_connect(DB_HOST, DB_USER, DB_PASS, DB_NAME);
...
<?php endif; ?>
<h3><?php echo __tr('Register for premium account') ?></h3>
...
<h3><?php echo __tr('Buy gift codes') ?></h3>
<form class="form-horizontal" target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="return" value="http://openjabnab.fr/ojn_admin/premium_done.php">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="on0" value="Duration">
...
<input type="submit" class="btn btn-primary" value="<?php echo __tr('Add to cart') ?>">
    ...
    <div class="span7">
        ...
        <div class="widget widget">
            <div class="widget-header">
                <i class="icon-list-alt"></i><h3><?php echo __tr("Gift codes") ?></h3>
            </div>
            <div class="widget-content">
<?php if(count($gifts)): ?>
...
<?php else:?>
    <div class="span12">
        ...
        <div class="widget widget">
            <div class="widget-header">
                <i class="icon-list-alt"></i><h3><?php echo __tr("Premium status and gift codes") ?></h3>
            </div>
            <div class="widget-content">
