...
<?php include_once('paypal.inc.php') ?>
        ...
        <div class="widget widget">
            <div class="widget-header">
                <i class="icon-list-alt"></i><h3><?php echo __tr("Development") ?></h3>
            </div>
            <div class="widget-content">
        ...
        <div class="widget widget">
            <div class="widget-header">
                <i class="icon-list-alt"></i><h3><?php echo __tr("Ideas") ?></h3>
            </div>
            <div class="widget-content">
...
<div class="row">
    ...
    <div class="span5">
        <div class="widget widget">
            <div class="widget-header">
                <i class="icon-list-alt"></i><h3><?php echo __tr("How to help the project ?") ?></h3>
            </div>
            <div class="widget-content">
            </div>
        </div>
