...
<div class="row">
  <div class="col-md-6">
    <div class="card">
      <h6 class="card-header">
        <i class="icon-bookmark"></i> <?php echo __tr('Shortcuts') ?>
      </h6>
      <div class="card-body shortcuts">
        ...
        <a href="/bunny/index.php?b=clear" class="shortcut">
          <img src="media/img/NabzGrey32.png" alt="Nab" class="py-3" />
    ...
    <div class="card">
      <h6 class="card-header">
        <i class="icon-bookmark"></i> <?php echo __tr('Informations !') ?>
      </h6>
      <div class="card-body">
  ...
  <div class="col-md-6">
    <div class="card">
      <h6 class="card-header">
        <i class="icon-file"></i> <?php echo __tr('Bunnies status') ?>
      </h6>
      <div class="card-body">
<?php
$ip = false;
...
?>
      ...
      <table class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          <?php else: ?>
          <tr>
            <td colspan="4"><?php echo __tr('You have no bunny in your account') ?></td>
          </tr>
          <?php endif; ?>
        </tbody>
      </table>
...
if(mysqli_num_rows($res)) { ?>
        <div class="card">
          <div class="card-header"><i class="icon-file"></i><h3><?php echo __tr('Server status') ?></h3></div>
          <div class="card-body">
      <span>
...
?>
    <div class="card">
      <h6 class="card-header">
        <i class="icon-file"></i> <?php echo __tr('Server status') ?>
      </h6>
      <div class="card-body">
        <table class="table table-bordered table-striped">
          <tbody>
