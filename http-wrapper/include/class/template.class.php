	...
	private function makeUserMenu()	{
		...
		if(isset($this->UInfos['token']) && $this->UInfos['token'] != '')
		{
			if($this->UInfos['isAdmin']) {
				...
				$menu .= '    <h6 class="dropdown-header">'.__tr('Server').'</h6>'."\n";
				$menu .= '    <a class="dropdown-item" href="/admin/server/index.php?tab=plugins">'.__tr("Plugins").'</a>'."\n";
				$menu .= '    <a class="dropdown-item" href="/admin/server/index.php?tab=bunnies">'.__tr("Bunnies").'</a>'."\n";
				$menu .= '    <a class="dropdown-item" href="/admin/server/index.php?tab=ztamps">'.__tr("Ztamps").'</a>'."\n";
				$menu .= '    <a class="dropdown-item" href="/admin/server/index.php?tab=accounts">'.__tr("Accounts").'</a>'."\n";
				$menu .= '    <a class="dropdown-item" href="/admin/server/faq.php">'.__tr("FAQ").'</a>'."\n";
				...
				$menu .= '    <a class="dropdown-item" href="/admin/account/quota.php">'.__tr("Quotas").'</a>'."\n";
				$menu .= '    <a class="dropdown-item" href="/admin/account/donation.php">'.__tr("Donations").'</a>'."\n";
				$menu .= '    <a class="dropdown-item" href="/admin/account/premium.php">'.__tr("Premium").'</a>'."\n";
				$menu .= '    <div class="dropdown-divider"></div>'."\n";
				$menu .= '    <h6 class="dropdown-header">'.__tr('Bunnies').'</h6>'."\n";
				...
				$menu .= '    <a class="dropdown-item" href="/admin/translation/language.php">'.__tr("Languages").'</a>'."\n";
				$menu .= '  </div>'."\n";
				$menu .= '</li>'."\n";
			}
