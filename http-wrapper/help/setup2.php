    ...
    <div class="span12">
        <div class="widget widget-nopad">
            <div class="widget-header">
                <i class="icon-list-alt"></i><h3><?php echo __tr("How to setup my bunny ?") ?></h3>
            </div> 
            <div class="widget-content">
		<br />
		<table class="span11 table-striped table">
			<tbody>
				<tr>
					<td><?php echo __tr('Step %1', 1) ?></td>
					<td>
				...
				<tr>
					...
					<?php echo __tr('The name of the network created is "NabaztagXX", where XX are the last two caracters of the MAC address') ?>.
					<?php echo __tr('For example, if the MAC address of the bunny is 00123456789, the wifi is going to be named "Nabaztag89"') ?>.
