...
public:
  ...
  // Plugin type
  int GetType() const;
  virtual const QStringList GetLanguages() { return QStringList() << "fr"; }
  virtual const QString GetVersion() { return "0.0.0"; }
  virtual const int GetBootcodeRequirement() { return 0; }
  virtual const QHash<QString, QString> GetChangelog() { return QHash<QString, QString>(); }
  ...
  virtual const QHash<QString, QString> GetExtendedApiFunctions() { return QHash<QString, QString>(); }
